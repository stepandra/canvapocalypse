import * as TldrawStore from '@tldraw/store'
import {
	BaseRecord,
	Migration,
	MigrationSequence,
...
type CreateRecordMigrationSequence = (options: {
	recordType: string
	retroactive?: boolean
	sequenceId: string
	sequence: RecordMigration[]
}) => MigrationSequence

const createRecordMigrationSequence = (
	TldrawStore as typeof TldrawStore & {
