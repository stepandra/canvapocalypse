...
const App = ({
  ...
  useEffect(() => {
    uiStateActions.setFocusItemIds(focusItemIds);
  }, [focusItemIds, uiStateActions]);

  useEffect(() => {
    onItemSelected?.(itemControls?.type === 'ADD_ITEM' ? null : itemControls);
  }, [itemControls, onItemSelected]);
